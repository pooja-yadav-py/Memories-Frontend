...
function ForgetPassword(){
    const [resetPasswordEmail, setResetPasswordEmailEmail] = useState('');
    const ResetPasswordHandleChange = (e)=>{
        console.log(e.target.value)
        setResetPasswordEmailEmail(e.target.value)
    }
         ...
         <Container className="inner-div" >              
           ...
           <h1 align="center">
            ...
            <Grid container spacing={1} >                
             <Button variant="contained" type='submit' style={{margin:'auto'}}>send instructions</Button>                
            </Grid>    
            <Grid container spacing={1} style={{marginTop:'10px'}} > 
            <Link to='/signup' style={{margin:'auto'}}>signup</Link> 
            </Grid>                   
